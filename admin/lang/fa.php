...
return array(
	...
	'LANG'			=>	'fa',
	'TITLE'			=>	'فارسی (Persian)',
	'LDIR'			=>	'rtl', // ltr, rtl, auto
	
	'SignInMsg'		=>	'لطفا نام کاربری و رمز عبور را وارد نمایید',
	'Login'			=>	'ورود',
	...
	'AdminPageTitle' 	=>	'مدیریت وازیگیت',
	'OverviewTitle'		=>	'چشم انداز کلی',
	'CannotDetermined'	=>	'تشخیص غیر ممکن است!',
	'Radio'			=>	'رادیوی LoRa',
	'Basic'			=>	'مقدماتی',
	'Advance'		=>	'پیشرفته',
	'Enabled'		=>	'فعال',
	...
	'BasicConfTitle'=>	'تنظیمات مقدماتی',
	'Gateway'		=>	'گیت وی',
	'RadioFreq'		=>	'فرکانس رادیویی',
	'LoraMode'		=>	'LoRa Mode',
	'Encryption'	=>	'رمزنگاری LoRa',
	'GPScoordinates'=>	'مختصات GPS',
	'SelectAmode'	=>	'یک مود را انتخاب نمایید',
	'GatewayID'		=>	'شناسه گیت وی',
	'MacAddress'	=>	'آدرس مک',
	...
	'Cloud'			=>	'ابر',
	'Clouds'		=>	'ابرها',
	'CloudTitle'	=>	'راه اندازی ابر',
	'Domain'		=>	'دامنه',
	'Visibility'	=>	'نمایش داده ها',
	'PublicVisibility'	=>	'نمایش عمومی',
	
	'Overview'		=>	'چشم انداز کلی',
	'Configurations'=>	'تنظیمات',
	'SetupWizard'	=>	'راه اندازی آسان',
	'Maintenance'	=>	'نگهداری',
	'TestDebug'	=>	'عیب یابی',
	'Update'	=>	'به روز رسانی',
	'Notifications'		=>	'پیام ها',
	'SensorsList'		=>	'لیست حسگرها',
	...
	'Profile'			=>	'تنظیمات کاربری',
	'NewPassword'		=>	'رمز عبور جدید',
	'CurrentUsername'	=>	'نام کاربری فعلی',
	'CurrentPassword'	=>	'رمز فعلی',
	'NewUsername'		=>	'نام کاربری جدید',
	'RepeatNewPassword'	=>	'تکرار رمز جدید',
	'FillAll'			=>	'لطفا تمام فیلدها را پر نمایید!',
	'PasswordNotMatch'	=>	'رمز جدید با تکرار رمز جدیدی تطابق ندارد!',
