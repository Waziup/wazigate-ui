...
//==================================
	...
	$.post("?cfg=radio_conf", {band:band, freq: freq}, function(data){
...
//==================================
    ...
    $('#btn_gw_id_submit').click(function() {	
...
//==================================	
	...
	$('#btn_submit_position').click(function(){
		...
		$.post("?cfg=system/conf", {ref_latitude: ref_latitude.toString(),ref_longitude: ref_longitude.toString()}, function(data){	
				$("#gw_config_msg").html(data);
		    			//erase message after 5 seconds
		   			setTimeout(function() {
	  					$('#gw_config_msg').html("");
...
//==================================
	...
	$("#profile_form").submit(function(event){
        ...
        $.post( "?", formValues, function(data){
            // Display the returned data in browser
	    $("#system_msg").html(data).fadeIn().delay(5000).fadeOut('slow');;
            //erase message after 5 seconds
        });
        //$('#profile_form')[0].reset();
